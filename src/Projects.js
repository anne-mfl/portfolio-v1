...
function Projects() {
  ...
  return (
    <div className='pt-28 mx-6 md:mx-36' id='projects' ref={projectsRef}>
      <ScrollAnimation animateIn="fadeInUp">
        <h1 className='font-montserrat text-2xl md:text-3xl border-b-2 w-fit pb-2 border-beige mb-8'> Projects</h1>
      </ScrollAnimation>
